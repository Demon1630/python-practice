...
def panduan(cookie):
    ...
    url = 'https://webvpn.nankai.edu.cn/https/77726476706e69737468656265737421fcfe4395247e6651700388a5d6502720c6dba7/ClientWeb/pro/ajax/center.aspx?vpn-12-o2-libic.nankai.edu.cn&act=get_History_resv&strat=90&StatFlag=New&_=1637505304830'
    ...
    print(date)
    # print(date.find('未生效'))
    # print(type(date.find('未生效')))

    rsvId = date.find('rsvId')
    print(rsvId)
    ID = date[rsvId+7:rsvId+15]
    print(f'获得的id是：{ID}')
    ...
    if date.find('未生效') != '-1':
        ...
        send_wechat('图书馆预约取消通知','超预约时间半小时了....还不去,已经给你取消预约了,自己记得重新去预约哦','https://webvpn.nankai.edu.cn/https/77726476706e69737468656265737421fcfe4395247e6651700388a5d6502720c6dba7/clientweb/xcus/ic2/Default.aspx')

    else:
        print('已经到图书馆打卡生效了，不需要取消')
        send_wechat('图书馆通知','这么早就去图书馆了,老婆子辛苦了!','https://webvpn.nankai.edu.cn/https/77726476706e69737468656265737421fcfe4395247e6651700388a5d6502720c6dba7/clientweb/xcus/ic2/Default.aspx')


    # for i in response.text.items():
    #     print(i)
    # print(date['msg'])
...
def quxiao(cookie,ID):
    ...
    # url = 'https://webvpn.nankai.edu.cn/https/77726476706e69737468656265737421fcfe4395247e6651700388a5d6502720c6dba7/ClientWeb/pro/ajax/reserve.aspx?vpn-12-o2-libic.nankai.edu.cn&act=del_resv&id=24374567&_=1637505304828'
    url = 'https://webvpn.nankai.edu.cn/https/77726476706e69737468656265737421fcfe4395247e6651700388a5d6502720c6dba7/ClientWeb/pro/ajax/reserve.aspx?vpn-12-o2-libic.nankai.edu.cn&act=del_resv&id='+ID+'&_=1637505304828'
